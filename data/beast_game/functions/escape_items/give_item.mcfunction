execute if score #NUM ITEM matches 1 run give @e[type=player,team=Survivors,sort=nearest,limit=1] iron_axe{display:{Name:'{"text":"Iron Axe","color":"gray","bold":true,"italic":false}'},CanDestroy:["minecraft:crafting_table"],Unbreakable:1,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:0.0,Operation:1}]} 1
