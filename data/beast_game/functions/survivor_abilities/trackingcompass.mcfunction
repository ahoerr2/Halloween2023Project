...
execute if score #NUM ITEM_OBTAINED matches 0 if score #NUM SPAWN matches 2 as @s[scores={compass_windup_time=100..}] at @s run item replace entity @s weapon.mainhand with compass{display:{Name:'[{"text":"Tracking Compass: ","color":"green","italic":false},{"text": "[Calibrated]","color": "dark_green"}]'},Unbreakable:1b,LodestoneDimension:"minecraft:overworld",LodestoneTracked:1b,LodestonePos:{X:-417,Y:61,Z:18}} 1
execute if score #NUM ITEM_OBTAINED matches 0 if score #NUM SPAWN matches 3 as @s[scores={compass_windup_time=100..}] at @s run item replace entity @s weapon.mainhand with compass{display:{Name:'[{"text":"Tracking Compass: ","color":"green","italic":false},{"text": "[Calibrated]","color": "dark_green"}]'},Unbreakable:1b,LodestoneDimension:"minecraft:overworld",LodestoneTracked:1b,LodestonePos:{X:-328,Y:73,Z:7}} 1
execute if score #NUM ITEM_OBTAINED matches 0 if score #NUM SPAWN matches 4 as @s[scores={compass_windup_time=100..}] at @s run item replace entity @s weapon.mainhand with compass{display:{Name:'[{"text":"Tracking Compass: ","color":"green","italic":false},{"text": "[Calibrated]","color": "dark_green"}]'},Unbreakable:1b,LodestoneDimension:"minecraft:overworld",LodestoneTracked:1b,LodestonePos:{X:-407,Y:73,Z:44}} 1
execute if score #NUM ITEM_OBTAINED matches 0 if score #NUM SPAWN matches 5 as @s[scores={compass_windup_time=100..}] at @s run item replace entity @s weapon.mainhand with compass{display:{Name:'[{"text":"Tracking Compass: ","color":"green","italic":false},{"text": "[Calibrated]","color": "dark_green"}]'},Unbreakable:1b,LodestoneDimension:"minecraft:overworld",LodestoneTracked:1b,LodestonePos:{X:-445,Y:75,Z:64}} 1

execute if score #NUM ITEM_OBTAINED matches 1 if score #NUM ITEM matches 1 as @s[scores={compass_windup_time=100..}] at @s run item replace entity @s weapon.mainhand with compass{display:{Name:'[{"text":"Tracking Compass: ","color":"green","italic":false},{"text": "[Calibrated]","color": "dark_green"}]'},Unbreakable:1b,LodestoneDimension:"minecraft:overworld",LodestoneTracked:1b,LodestonePos:{X:-393,Y:75,Z:67}} 1
execute if score #NUM ITEM_OBTAINED matches 1 if score #NUM ITEM matches 2 as @s[scores={compass_windup_time=100..}] at @s run item replace entity @s weapon.mainhand with compass{display:{Name:'[{"text":"Tracking Compass: ","color":"green","italic":false},{"text": "[Calibrated]","color": "dark_green"}]'},Unbreakable:1b,LodestoneDimension:"minecraft:overworld",LodestoneTracked:1b,LodestonePos:{X:380,Y:104,Z:51}} 1
execute if score #NUM ITEM_OBTAINED matches 1 if score #NUM ITEM matches 3 as @s[scores={compass_windup_time=100..}] at @s run item replace entity @s weapon.mainhand with compass{display:{Name:'[{"text":"Tracking Compass: ","color":"green","italic":false},{"text": "[Calibrated]","color": "dark_green"}]'},Unbreakable:1b,LodestoneDimension:"minecraft:overworld",LodestoneTracked:1b,LodestonePos:{X:-435,Y:68,Z:62}} 1
execute if score #NUM ITEM_OBTAINED matches 1 if score #NUM ITEM matches 4 as @s[scores={compass_windup_time=100..}] at @s run item replace entity @s weapon.mainhand with compass{display:{Name:'[{"text":"Tracking Compass: ","color":"green","italic":false},{"text": "[Calibrated]","color": "dark_green"}]'},Unbreakable:1b,LodestoneDimension:"minecraft:overworld",LodestoneTracked:1b,LodestonePos:{X:-454,Y:74,Z:35}} 1
