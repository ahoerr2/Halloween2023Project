...
execute as @a[team=Survivors,scores={vanish_percent=1..}] at @s if predicate beast_game:is_sneaking run effect give @s slowness 1 4 true
execute as @a[team=Survivors,scores={vanish_percent=1..}] at @s if predicate beast_game:is_sneaking run tag @s add Vanished
...
execute as @e[team=Survivors,scores={vanish_percent=1..}] run scoreboard players operation @s vanish_display_rate = @s vanish_percent
execute as @e[team=Survivors,scores={vanish_percent=1..}] run scoreboard players operation @s vanish_display_rate /= @s vanish_convert_rate
execute as @a[team=Survivors,scores={vanish_percent=1..}] at @s if predicate beast_game:is_sneaking run title @s actionbar [{"text":"Vanish Time Remaining ","color": "aqua"},{"text":"[Hold Shift]: ","color": "gold"},{"score":{"name":"*", "objective":"vanish_display_rate"},"color": "green"},{"text":"s","color": "aqua"}]
